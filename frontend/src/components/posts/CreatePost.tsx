      ...
      {visable === 0 && (
        <>
          ...
          <div className="p-3 h-36">
            <textarea
              className="w-[505px] h-36 border-0 resize-none overflow-y-scroll scrollbar-thin  scrollbar-thumb-gray-200  scrollbar-thumb-rounded-md"
              placeholder={
          ...
          <div className="flex flex-row gap-2 justify-between px-3 py-5 w-[530px]">
            ...
            <div className="relative">
              {/* <img src="./images/emoji/emoji.png" className="w-8 h-8" /> */}
              <EmojiPicker height={300} width={290} />
            </div>
          </div>
          <div className="flex flex-row justify-between gap-3 items-center border-2 border-gray-300 rounded-md px-3 py-2 mx-2 w-[510px]">
